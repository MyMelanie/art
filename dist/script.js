...
var accordion = function accordion(triggersSelection) {
  var btns = document.querySelectorAll(triggersSelection);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResours"])('http://localhost:3000/styles').then(function (res) {
      ...
      return console.log('Упс, сервер не отвечает. Давайте подождем');
    });
    this.remove();
  });
